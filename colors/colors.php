 ...
 * @param $defaultColor {string} — Which color in hex format should be selected by default in new documents. This is only used in situations where the TV does not have a default value specified in the TV definition. Default: '#ffffff'.
...
function mm_widget_colors(
	...
	if ($e->name == 'OnDocFormPrerender'){
		...
		$tvCount = tplUseTvs($mm_current_page['template'], $fields);
